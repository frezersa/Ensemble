...
#Save plot
png(file.path(parentfolder,"Daily_Precip.png"),
...
#Save plot
png(file.path(parentfolder,"Precip_pred.png"),
    width=20,height=16,units="cm",res=90)
p
garbage<-dev.off()
cat("Precip_pred.png\n")
...
#Plot last 1 day*********************************************
out_filename <- "Precip_hist1days.png"
png(file.path(parentfolder,out_filename),
    width=20,height=16,units="cm",res=90)
...
#Plot last 2 days*********************************************
out_filename <- "Precip_hist2days.png"
png(file.path(parentfolder,out_filename),
    width=20,height=16,units="cm",res=90)
...
#Plot last 3 days*********************************************
out_filename <- "Precip_hist3days.png"
png(file.path(parentfolder,out_filename),
    width=20,height=16,units="cm",res=90)
...
#Save plot
png(file.path(parentfolder,"Temp_pred.png"),
          ,width=20,height=16,units="cm",res=90)
p
garbage<-dev.off()
cat("Temp_pred.png\n")
...
png(file.path(outputfolder,"Precip_Ensemble.png"),
    ,width=20,height=16,units="cm",res=90)
print(p)
garbage<-dev.off()
